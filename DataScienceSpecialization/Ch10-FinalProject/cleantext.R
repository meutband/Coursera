...
suppressPackageStartupMessages(c(library(magrittr),library(data.table),library(RWeka),
                                 library(tm),library(RSQLite),library(stringr),library(slam)))
...
twitter <- samplefile('/Users/meutband/Desktop/Coursera/DataScienceSpecialization/10Capstone/data/final/en_US/en_US.twitter.txt', .013)
blogs <- samplefile('/Users/meutband/Desktop/Coursera/DataScienceSpecialization/10Capstone/data/final/en_US/en_US.blogs.txt', .013)
news <- samplefile('/Users/meutband/Desktop/Coursera/DataScienceSpecialization/10Capstone/data/final/en_US/en_US.news.txt', .013)
...
db <- dbConnect(SQLite(), dbname="ShinyApp/alldata.db")
dbSendQuery(conn=db, 
            "CREATE TABLE NGram 
            (pre TEXT, 
            word TEXT,
